        ...
        <details :open="true" class="border p-4 rounded-lg border-color-4">
            ...
            <div class="flex flex-wrap gap-4">
                <div class="grow">
                    ...
                    <input v-model="store.beneficiario.cui" type="text" maxlength="13" minlength="13" class="input focus:outline-none" :class="{'border-red-400':store.errors.hasOwnProperty('cui')}" readonly disabled>
                </div>
                <div class="grow">
