...
<template>
    <section class="lg:px-7">
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-3  gap-4">
            <template v-for="curso in paginatedData">
                <Card v-if="curso.deleted_at == null"  class="overflow-hidden border border-blue-muni">
                    <template #header>
                        <img :src="curso.curso.imagen ? curso?.curso?.urlImage : ''" 
                             :alt="curso.nombre" 
